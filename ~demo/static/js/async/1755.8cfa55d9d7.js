/*! LICENSE: 1755.8cfa55d9d7.js.LICENSE.txt */
"use strict";(self.rspackChunk_dataops_code_editor=self.rspackChunk_dataops_code_editor||[]).push([[1755],{6134(e,t,a){a.r(t);var r={comments:{lineComment:"//",blockComment:["/*","*/"]},brackets:[["{","}"],["[","]"],["(",")"]],autoClosingPairs:[{open:"[",close:"]"},{open:"{",close:"}"},{open:"(",close:")"}],surroundingPairs:[{open:"{",close:"}"},{open:"[",close:"]"},{open:"(",close:")"}]};function o(e){let t=[],a=e.split(/\t+|\r+|\n+| +/);for(let e=0;e<a.length;++e)a[e].length>0&&t.push(a[e]);return t}var n=o("true false"),i=o(`
			  alias
			  break
			  case
			  const
